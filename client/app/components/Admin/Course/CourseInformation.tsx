      ...
      <form onSubmit={handleSubmit} className={`${styles.label}`}>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            cols={30}
            rows={8}
            placeholder="Write  a short description about the course here..."
            className={`${styles.input} !h-min !py2`}
        ...
        <div className="w-full flex justify-between ">
          <div className="w-[45%]">
            ...
            <input
              ...
              id="tags"
              placeholder="Mern, Next 13, React, Socket io"
              className={`${styles.input}`}
            />
          </div>
          <div className="w-[50%]">
            ...
            <select
              className={`${styles.input} !bg-[#070a10]`}
