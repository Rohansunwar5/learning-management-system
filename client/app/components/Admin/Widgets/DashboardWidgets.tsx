  ...
  return (
    <div className="mt-[30px] min-h-screen">
      <div className="grid grid-cols-[75%,25%]">
        <div className="pl-10 p-8 mr-5 ">
          <UserAnalytics isDashboard={true} />
        </div>

        <div className="pt-[80px] pr-8">
          <div className="w-full rounded-xl shadow dark:bg-[#111C43]">
            <div className="flex items-center p-5 justify-between">
              ...
              <div>
                ...
                <h5 className="dark:text-white  text-black  text-center pt-4">
                  {ordersComparePercentage?.percentageChange !== undefined &&
          ...
          <div className="w-full rounded-xl shadow my-8 dark:bg-[#111C43]">
            <div className="flex items-center justify-between p-5">
              <div className="">
                ...
                <h5 className="py-2 dark:text-[#45CBA0] text-black font-Poppins text-[20px] font-[400]">
                  New Users
                </h5>
              </div>
              <div>
                ...
                <h5 className="dark:text-white  text-black text-center pt-4">
                  {userComparePercentage?.percentageChange !== undefined &&
      ...
      <div className="grid grid-cols-[65%, 35%] mt-[-20px]">
        <div className="dark:bg-[#111c43] w-[94%] mt-[30px] h-[40vh] shadow-sm m-auto pl-5">
          <OrderAnalytics isDashboard={true} />
        </div>
        <div className="p-5">
          <h5 className="dark:text-[#fff] text-black text-[20px] font-[400] font-Poppins pb-3 pl-5">
            Recent Transaction
          </h5>
          <div className="pl-5">
