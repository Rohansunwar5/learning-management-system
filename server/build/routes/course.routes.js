...
courseRouter.get("/get-allcourses", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCoursesAdmin);
//TODO: for demo removeing is authorized
