...
export const loginUser = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (!(email || password)) {
        return next(
          new ErrorHandler("Please enter your email and password", 401)
        );
      }
...
// social auth
// this will be implemented from frontend, when user will send email and password after next auth we will simply hit this endpoint
